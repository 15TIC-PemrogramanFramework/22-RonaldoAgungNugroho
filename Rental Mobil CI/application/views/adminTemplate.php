...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
                ...
                elseif($status==''){
                    echo "<li>".anchor('login_admin','<i class="fa fa-user fa-fw"></i> Admin Menu '.$this->session->userdata('username'))."</li>";
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                       ...
                       echo "<li>".anchor('login_admin',"<i class='fa fa-bar-chart-o fa-fw'></i> DASHBOARD")."</li>";                        
                ...
                <!--notification start-->
                    ...
                    <div class="notify-w3ls">
                        <div class="alert alert-info clearfix">
                            ...
                            <div class="notification-info">
                                <ul class="clearfix notification-meta">
                                    <li class="pull-left notification-sender"><span><a href="<?php echo base_url();?>/assets2/#">Jonathan Smith</a></span> send you a mail </li>
                        ...
                        <div class="alert alert-danger">
                            ...
                            <div class="notification-info">
                                <ul class="clearfix notification-meta">
                                    <li class="pull-left notification-sender"><span><a href="<?php echo base_url();?>/assets2/#">Jonathan Smith</a></span> mentioned you in a post </li>
                        ...
                        <div class="alert alert-success ">
                            ...
                            <div class="notification-info">
                                ...
                                <p>
                                    <a href="<?php echo base_url();?>/assets2/#">Anjelina Mewlo, Jack Flip</a> and <a href="<?php echo base_url();?>/assets2/#">3 others</a>
                                </p>
                            </div>
                        </div>
 ...
 <!-- footer -->
          <div class="footer">
            <div class="wthree-copyright">
              <p>© 2017 Visitors. All rights reserved | Design by <a href="<?php echo base_url();?>/assets2/http://w3layouts.com">W3layouts</a></p>
            </div>
          </div>
  <!-- / footer -->
</section>
...
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/bootstrap.js"></script>
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/jquery.dcjqaccordion.2.7.js"></script>
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/scripts.js"></script>
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/jquery.slimscroll.js"></script>
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/jquery.nicescroll.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/jquery.scrollTo.js"></script>
<!-- morris JavaScript -->  
<script>
...
<!-- calendar -->
    <script type="text/javascript" href="<?php echo base_url();?>/assets2/<?php echo base_url();?>/assets2/js/monthly.js"></script>
